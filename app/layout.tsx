...
export const metadata: Metadata = {
	...
	description:
		'Профессиональный детейлинг, который преображает ваш автомобиль.Максимальное внимание к деталям и только премиальные материалы длябезупречного результата',
	keywords:
