						...
						<div className='grid md:grid-cols-2 gap-8 items-center'>
							<div itemProp='description'>
								<p className='text-gray-400 mb-4'>
									NEWTONE - это премиальный центр детейлинга, предоставляющий
									исключительный сервис и результаты. Имея многолетний опыт и
									страсть к совершенству, наша команда профессионалов использует
									только высококачественные продукты и передовые технологии для
									восстановления и улучшения внешнего вида вашего автомобиля.
								</p>
								<p className='text-gray-400'>
									Мы гордимся нашим вниманием к деталям и стремлением к
									удовлетворению клиентов. Независимо от того, ищете ли вы
									базовую мойку или полный пакет детейлинга, у нас есть опыт,
									чтобы превзойти ваши ожидания и сделать ваш автомобиль
									безупречным.
								</p>
							</div>
							<div className='relative h-[300px] rounded-none overflow-hidden border border-gray-800'>
								<Image
									...
									alt='NEWTONE - Премиальный Детейлинг Центр в Астане'
									fill
